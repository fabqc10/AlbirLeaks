    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/conversations").hasRole("USER")
                        .requestMatchers(HttpMethod.POST, "/api/conversations/job/{jobId}").authenticated()
                        .requestMatchers(HttpMethod.GET, "/api/conversations/{conversationId}/messages").hasRole("USER")
                        .requestMatchers(HttpMethod.POST, "/api/conversations/{conversationId}/messages").hasRole("USER")
